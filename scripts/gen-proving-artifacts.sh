...
# used and deleted on every exit. It is deliberately never cached or committed.
#
# Prerequisites:
#
#   A `circom` built from THIS CRATE'S PINNED UPSTREAM REVISION
#   (`rev = "ad44e915a12bb047b05745c2884aad9cc8326bc6"` in Cargo.toml), not whatever
#   is on PATH. This is the immutable commit for the upstream Circom 2.2.3 release:
#
...
echo "note: this MUST be upstream Circom 2.2.3 at rev ad44e915a12bb047b05745c2884aad9cc8326bc6."
